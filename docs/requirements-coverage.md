...
| `OBS-01` | Частично | Base HTTP metrics/tracing, REQUEST pair и ordinary/SSE RESPONSE outcome/latency pair с separate response inspection span существуют; identity metrics отсутствуют. |
